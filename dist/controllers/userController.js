...
exports.signUp = (0, handlers_1.AsyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.signIn = (0, handlers_1.AsyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.getUser = (0, handlers_1.AsyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    let user = yield Dataprovider_1.default.getDataByID(User_schema_1.default, id);
    Responders_1.Success.send(res, 200, user);
}));
exports.forgotPassword = (0, handlers_1.AsyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let { email } = req.body;
...
exports.passwardReset = (0, handlers_1.AsyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.Protected = (0, handlers_1.AsyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    Logger_1.default.debug("Protected route triggered");
    return res
        .status(200)
        .json({ success: true, message: "Protected route triggered" });
}));
exports.signOut = (0, handlers_1.AsyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
