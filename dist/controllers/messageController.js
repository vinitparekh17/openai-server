  ...
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      Socket_1.io.on("connect", () => {
        ...
        completionPromise
          .then((completion) =>
            Socket_1.io.emit("create_completion", completion)
          )
          .catch((err) => Logger_1.default.error(err));
        Socket_1.io.on("data", (data) =>
          Socket_1.io.emit("completion", data.choices[0].text)
        );
        Socket_1.io.on("error", (e) => Logger_1.default.error(e));
        Socket_1.io.on("disconnect", () =>
          Logger_1.default.debug("Disconnected from socket!")
        );
      });
    } catch (error) {
...
function getConversation(req, res, next) {
  return __awaiter(this, void 0, void 0, function* () {
    try {
      const data = yield Dataprovider_1.default.getData(
        Message_schema_1.default
      );
      if (!data) return Responders_1.Err.send(res, 404, "Data not found!");
